    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_number', models.IntegerField(blank=True, help_text='Oryginalny numer dokumentu z Subiektu', null=True, verbose_name='Oryginalny numer dokumentu')),
                ('document_id', models.IntegerField(blank=True, help_text='ID dokumentu z Subiektu (dok_Id)', null=True, verbose_name='ID dokumentu')),
