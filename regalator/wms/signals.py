    ...
    try:
        ...
        if instance.location_type == 'zone':
            ...
            zone = WarehouseZone.objects.create(
                ...
                x=Decimal('0.00'),
                y=Decimal('0.00'),
                description=f"Strefa zsynchronizowana z Location: {instance.barcode}"
            )
            ...
            rack = WarehouseRack.objects.create(
                ...
                x=Decimal('0.00'),
                y=Decimal('0.00'),
                description=f"Regał zsynchronizowany z Location: {instance.barcode}"
            )
            ...
            shelf = WarehouseShelf.objects.create(
                ...
                x=Decimal('0.00'),
                y=Decimal('0.00'),
                description=f"Półka zsynchronizowana z Location: {instance.barcode}"
            )
